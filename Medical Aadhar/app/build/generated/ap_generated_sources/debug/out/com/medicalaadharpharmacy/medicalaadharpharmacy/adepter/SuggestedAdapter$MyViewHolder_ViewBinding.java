...
public class SuggestedAdapter$MyViewHolder_ViewBinding implements Unbinder {
  private SuggestedAdapter.MyViewHolder target;

  @UiThread
  public SuggestedAdapter$MyViewHolder_ViewBinding(SuggestedAdapter.MyViewHolder target,
      View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    SuggestedAdapter.MyViewHolder target = this.target;
