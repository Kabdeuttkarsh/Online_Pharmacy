...
public class PrescriptionOrderDetailsActivity$ItemAdp$ViewHolder_ViewBinding implements Unbinder {
  private PrescriptionOrderDetailsActivity.ItemAdp.ViewHolder target;

  @UiThread
  public PrescriptionOrderDetailsActivity$ItemAdp$ViewHolder_ViewBinding(
      PrescriptionOrderDetailsActivity.ItemAdp.ViewHolder target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    PrescriptionOrderDetailsActivity.ItemAdp.ViewHolder target = this.target;
