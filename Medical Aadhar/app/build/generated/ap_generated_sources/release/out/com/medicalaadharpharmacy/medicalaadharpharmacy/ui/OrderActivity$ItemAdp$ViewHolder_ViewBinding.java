...
public class OrderActivity$ItemAdp$ViewHolder_ViewBinding implements Unbinder {
  private OrderActivity.ItemAdp.ViewHolder target;

  @UiThread
  public OrderActivity$ItemAdp$ViewHolder_ViewBinding(OrderActivity.ItemAdp.ViewHolder target,
      View source) {
    this.target = target;
    ...
    target.txtPay = Utils.findRequiredViewAsType(source, R.id.txt_pay, "field 'txtPay'", TextView.class);
  }

  @Override
  @CallSuper
  public void unbind() {
    OrderActivity.ItemAdp.ViewHolder target = this.target;
