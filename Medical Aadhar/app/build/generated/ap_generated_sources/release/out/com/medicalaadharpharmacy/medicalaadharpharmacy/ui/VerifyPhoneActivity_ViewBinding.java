...
public class VerifyPhoneActivity_ViewBinding implements Unbinder {
  ...
  @UiThread
  public VerifyPhoneActivity_ViewBinding(VerifyPhoneActivity target) {
    this(target, target.getWindow().getDecorView());
  }

  @UiThread
  public VerifyPhoneActivity_ViewBinding(final VerifyPhoneActivity target, View source) {
    this.target = target;
  ...
  @CallSuper
  public void unbind() {
    VerifyPhoneActivity target = this.target;
