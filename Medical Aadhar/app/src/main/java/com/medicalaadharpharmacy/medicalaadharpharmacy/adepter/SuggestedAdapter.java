...
public class SuggestedAdapter extends RecyclerView.Adapter<SuggestedAdapter.MyViewHolder>{
        ...
        private List<Suggested> mMedicine;
        private SuggestedAdapter.RecyclerTouchListener listener;
        ...
        public SuggestedAdapter(Context mContext, List<Suggested> mMedicine, final SuggestedAdapter.RecyclerTouchListener listener) {
        ...
        @Override
        public void onBindViewHolder(final SuggestedAdapter.MyViewHolder holder, @SuppressLint("RecyclerView") int position) {
