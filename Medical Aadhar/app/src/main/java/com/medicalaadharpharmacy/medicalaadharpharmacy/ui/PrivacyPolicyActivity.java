...
import static com.medicalaadharpharmacy.medicalaadharpharmacy.utiles.SessionManager.policy;
        ...
        gsCall.enqueue(new Callback<GeneralSettingsResponse>() {
            ...
            public void onResponse(Call<GeneralSettingsResponse> call, Response<GeneralSettingsResponse> response) {
                if (response.isSuccessful()){
                    ...
                    txtDscirtion.setText(Html.fromHtml(generalData.get(9).getValue()));
                    ...
                    Toast.makeText(PrivacyPolicyActivity.this, "Error", Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<GeneralSettingsResponse> call, Throwable t) {
                Toast.makeText(PrivacyPolicyActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
