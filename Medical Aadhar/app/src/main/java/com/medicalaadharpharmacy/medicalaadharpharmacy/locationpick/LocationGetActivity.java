...
import com.medicalaadharpharmacy.medicalaadharpharmacy.ui.AddressActivity;
import com.medicalaadharpharmacy.medicalaadharpharmacy.ui.CartActivity;
...
public class LocationGetActivity extends AppCompatActivity implements OnMapReadyCallback{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(LocationGetActivity.this);
        ...
        if (i != null) {
            ...
            if (extras != null) {
                ...
                edState.setText(getIntent().getStringExtra("state"));
                edCountry.setText(getIntent().getStringExtra("country"));
                ...
                pincode1=getIntent().getStringExtra("pincode");
        ...
        switch (view.getId()) {
            case R.id.lvl_actionsearch:
                ...
                Intent intent = new Autocomplete.IntentBuilder(
                        ...
                        .build(this);
               // Toast.makeText(LocationGetActivity.this,placeAutocompleteRequestCode , Toast.LENGTH_SHORT).show();
    ...
    private class GetAddressFromLatLng extends AsyncTask<Double, Void, Bundle> {
        ...
        protected void onPostExecute(Bundle userAddress) {
            ...
            edAddress.setText(""+userAddress.getString("fulladdress"));
            edCity.setText(""+userAddress.getString("city"));
            edState.setText(""+userAddress.getString("state"));
            edCountry.setText(""+userAddress.getString("country"));
            edPincode.setText(""+userAddress.getString("postalcode"));
    ...
    private void addAddress() {
        ...
        custPrograssbar.prograssCreate(LocationGetActivity.this);
        Call<MyAddressResponse> call = APIClient.getInterface().addAddress(userid_,
                edHoseno.getText().toString(),
                edLandmark.getText().toString(),
                edPincode.getText().toString(),
                edCity.getText().toString(),
                edAddress.getText().toString(),
                String.valueOf(LocationGetActivity.this.mLatitude),
                String.valueOf(LocationGetActivity.this.mLongitude),
                atype.toString(),
        ...
        call.enqueue(new Callback<MyAddressResponse>() {
            ...
            public void onResponse(Call<MyAddressResponse> call, Response<MyAddressResponse> response) {
                ...
                if (response.isSuccessful()){
                    ...
                    startActivity(new Intent(LocationGetActivity.this, AddressActivity.class).setFlags(Intent.FLAG_ACTIVITY_NEW_TASK | Intent.FLAG_ACTIVITY_CLEAR_TASK));
                    finish();
                }else{
    ...
    private void updateAddress() {
        ...
        custPrograssbar.prograssCreate(LocationGetActivity.this);
        Call<MyAddressResponse> call = APIClient.getInterface().updateAddress(userid_,
                edHoseno.getText().toString(),
                edLandmark.getText().toString(),
                edPincode.getText().toString(),
                edCity.getText().toString(),
                ...
                edState.getText().toString(),
                edCountry.getText().toString(),
                String.valueOf(LocationGetActivity.this.aid));
        call.enqueue(new Callback<MyAddressResponse>() {
            @Override
            public void onResponse(Call<MyAddressResponse> call, Response<MyAddressResponse> response) {
                custPrograssbar.closePrograssBar();
