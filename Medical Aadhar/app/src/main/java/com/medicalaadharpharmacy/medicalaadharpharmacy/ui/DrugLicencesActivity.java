...
public class DrugLicencesActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        sessionManager = new SessionManager(DrugLicencesActivity.this);
        ...
        gsCall.enqueue(new Callback<GeneralSettingsResponse>() {
            ...
            public void onResponse(Call<GeneralSettingsResponse> call, Response<GeneralSettingsResponse> response) {
                if (response.isSuccessful()){
                    ...
                    Toast.makeText(DrugLicencesActivity.this, "Error", Toast.LENGTH_LONG).show();
                }
            }

            @Override
            public void onFailure(Call<GeneralSettingsResponse> call, Throwable t) {
                Toast.makeText(DrugLicencesActivity.this, t.getMessage(), Toast.LENGTH_LONG).show();
            }
        });
