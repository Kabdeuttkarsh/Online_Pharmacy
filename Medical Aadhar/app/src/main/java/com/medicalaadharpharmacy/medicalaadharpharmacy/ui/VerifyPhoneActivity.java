                ...
                call.enqueue(new Callback<ResendOTPresponse>() {
                    ...
                    public void onResponse(Call<ResendOTPresponse> call, Response<ResendOTPresponse> response) {
                        ...
                        if(response.isSuccessful()){
                            ...
                            Toast.makeText(VerifyPhoneActivity.this, "Try Again", Toast.LENGTH_SHORT).show();
                        }
                    }
...
//    RequestBody bodyRequest = RequestBody.create(MediaType.parse("application/json"), jsonObject.toString());
    Call<OtpResult> call = APIClient.getInterface().verifyOtpforSignup(number,otp);
    call.enqueue(new Callback<OtpResult>() {
        @Override
        public void onResponse(Call<OtpResult> call, Response<OtpResult> response) {
            if (response.isSuccessful()){
                if (response.body().getStatus().equals("OTP Mismatch.")){
        ...
        public void onFailure(Call<OtpResult> call, Throwable t) {
            Toast.makeText(VerifyPhoneActivity.this,t.toString(),Toast.LENGTH_LONG).show();
        }
    });
