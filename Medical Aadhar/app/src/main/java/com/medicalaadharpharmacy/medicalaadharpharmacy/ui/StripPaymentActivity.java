...
public class StripPaymentActivity extends AppCompatActivity {
    ...
    com.medicalaadharpharmacy.medicalaadharpharmacy.model.PaymentItem paymentItem;
    double amount = 0.0;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        paymentItem = (com.medicalaadharpharmacy.medicalaadharpharmacy.model.PaymentItem) getIntent().getSerializableExtra("detail");
        amount = getIntent().getDoubleExtra("amount", 0.0);
        txtTotal.setText("Total Amount : " + sessionManager.getStringData(currency) + new DecimalFormat("##.##").format(amount));
