...
import com.medicalaadharpharmacy.medicalaadharpharmacy.models.PrevPrescription;
...
public class CartUploadPrescriptionActivity extends RootActivity  {
    ...
    List<PrevPrescription> xyz1 = new ArrayList<>();
    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_cart_upload_prescription);
        ButterKnife.bind(this);
        custPrograssbar = new CustPrograssbar();
        sessionManager = new SessionManager(CartUploadPrescriptionActivity.this);
    ...
    private void uploadMultiFile(ArrayList<String> filePaths) {
        ...
        custPrograssbar.prograssCreate(CartUploadPrescriptionActivity.this);
        ...
        if (filePaths != null) {
            ...
            for (int i = 0; i < filePaths.size(); i++) {
                ...
                parts.add(prepareFilePart("image" + i, filePaths.get(i).toString()));
            }
...
// finally, execute the request
        Call<UploadResponse> call = APIClient.getInterface().uploadMultiFileCart(uid, addres, dCharge, size, parts);
        ...
        call.enqueue(new Callback<UploadResponse>() {
            ...
            public void onResponse(@NonNull Call<UploadResponse> call, @NonNull Response<UploadResponse> response) {
                ...
                Toast.makeText(CartUploadPrescriptionActivity.this,"Order Successful.", Toast.LENGTH_SHORT).show();
                //     if (restResponse.getResult().equalsIgnoreCase("true")) {
                lvlEmpty.setVisibility(VISIBLE);
                lvlPic.setVisibility(GONE);
                arrayListImage.clear();
                Intent intent = new Intent(CartUploadPrescriptionActivity.this, OrderActivity.class);
//                intent.putExtra("call","upload");
            ...
            public void onFailure(@NonNull Call<UploadResponse> call, @NonNull Throwable t) {
                ...
                Toast.makeText(CartUploadPrescriptionActivity.this,t.toString(), Toast.LENGTH_SHORT).show();
            }
    ...
    private MultipartBody.Part prepareFilePart(String partName, String fileUri) {
        ...
        if (fileUri != null && !fileUri.startsWith("http://") && !fileUri.startsWith("https://")) {
            ...
            file = getFile(CartUploadPrescriptionActivity.this, fileUri);
    ...
    public void postImage(ArrayList<String> urilist) {
        ...
        ImageAdp imageAdp = new ImageAdp(CartUploadPrescriptionActivity.this, urilist);
        ...
        switch (view.getId()) {
            ...
            case R.id.btn_submit:
                if (customer_id.equals("0")){
                    Intent intent = new Intent(CartUploadPrescriptionActivity.this, LoginActivity.class);
                    intent.putExtra("call","upload");
                    startActivity(intent);
                }else{
...
//                        {
//                            Log.d("pathto",arrayListImage.get(i).toString());
//                        }
            ...
            case R.id.txt_changeadress:
                startActivity(new Intent(CartUploadPrescriptionActivity.this, AddressActivity.class));
...
//    }
    ...
    public class ImageAdp extends RecyclerView.Adapter<ImageAdp.MyViewHolder> {
        ...
        public void onBindViewHolder(final MyViewHolder holder, int position) {
            ...
            Glide.with(CartUploadPrescriptionActivity.this)
    ...
    public void bottonChoseoption() {
        ...
        textViewCamera.setOnClickListener(v -> {
            ...
            imagePicker.withActivity(CartUploadPrescriptionActivity.this).chooseFromGallery(false).chooseFromCamera(true).withCompression(true).start();

        });

        textViewGallery.setOnClickListener(v -> {
            mBottomSheetDialog.cancel();
            imagePicker.withActivity(CartUploadPrescriptionActivity.this).chooseFromGallery(true).chooseFromCamera(false).withCompression(true).start();
    ...
    private void getPreviousPrescriptions(){
        if (user != null) {
            custPrograssbar.prograssCreate(CartUploadPrescriptionActivity.this);
            Call<PrevPrescriptionResponse> call = APIClient.getInterface().getPreviousPrescription(customer_id);
            call.enqueue(new Callback<PrevPrescriptionResponse>() {
                @Override
                public void onResponse(Call<PrevPrescriptionResponse> call, Response<PrevPrescriptionResponse> response) {
                    custPrograssbar.closePrograssBar();

                    if(response.isSuccessful()){
                        PrevPrescriptionResponse preresp=response.body();
                        List<PrevPrescription> resp = preresp.getData();

                        for (int i = 0; i < resp.size(); i++) {
                            arrayListImage.add(APIClient.baseUrl + "/uploads/prescription/"+ resp.get(i).getImage_rx_name());
                        }
                ...
                @Override
                public void onFailure(Call<PrevPrescriptionResponse> call, Throwable t) {
