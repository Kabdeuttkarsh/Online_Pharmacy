...
import com.medicalaadharpharmacy.medicalaadharpharmacy.fragment.Info1Fragment;
import com.medicalaadharpharmacy.medicalaadharpharmacy.fragment.Info2Fragment;
import com.medicalaadharpharmacy.medicalaadharpharmacy.fragment.Info3Fragment;
...
public class IntroActivity extends RootActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
       ...
       // if(sessionManager.getBooleanData(SessionManager.login)){
         ...
         //   finish();
      //  }
        if(sessionManager.getBooleanData("isprevset")){
            startActivity(new Intent(IntroActivity.this, HomeActivity.class));
        }
        else{
            sessionManager.setBooleanData("isprevset",true);
        }
